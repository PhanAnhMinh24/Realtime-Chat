...
const BodyRightSidebar: React.FC<IParams> = ({ conversationId }) => {
            ...
            <AccordionItem value="customize" className="border-none">
              ...
              <AccordionContent>
                <div className="space-y-2 pl-4">
                  <Button variant="ghost" className="w-full justify-start">Chủ đề</Button>
                  <Button variant="ghost" className="w-full justify-start">Cảm xúc</Button>
                </div>
              </AccordionContent>
            </AccordionItem>
                  ...
                  <AccordionContent>
                    <div className="space-y-4">
                      <div className="flex gap-1">
                        ...
                        <Button
                          variant={activeMediaTab === "FILE" ? "ghost" : "outline"}
                          className={cn(
                            "flex-1 justify-start gap-2 h-9",
